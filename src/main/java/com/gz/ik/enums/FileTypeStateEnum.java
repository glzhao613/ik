...
public enum FileTypeStateEnum {
	...
	private FileTypeStateEnum(int state, String stateInfo) {
		this.state = state;
	...
	public static FileTypeStateEnum stateOf(int index) {
		for (FileTypeStateEnum state : values()) {
